...
import 'package:news_app/services/sports_news_service.dart';
...
class _SportsNewsScreenState extends State<SportsNewsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.category == 'sports' ? 'Sports' : ''} News'),
        leading: IconButton(
