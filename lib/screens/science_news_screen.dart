...
import 'package:news_app/services/science_news_service.dart';
...
class _ScienceNewsScreenState extends State<ScienceNewsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.category == 'science' ? 'Science' : ''} News'),
        leading: IconButton(
