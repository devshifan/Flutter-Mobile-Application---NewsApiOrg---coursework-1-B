...
import 'package:news_app/services/business_news_service.dart';
...
class BusinessNewsScreen extends StatefulWidget {
  ...
  BusinessNewsScreen({required this.category});
  @override
...
class _BusinessNewsScreenState extends State<BusinessNewsScreen> {
  final BusinessNewsService _newsService = BusinessNewsService();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.category == 'business' ? 'Business' : ''} News'),
        leading: IconButton(
