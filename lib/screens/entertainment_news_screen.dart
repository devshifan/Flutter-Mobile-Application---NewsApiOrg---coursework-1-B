...
import 'package:news_app/services/entertainment_news_service.dart';
...
class EntertainmentNewsScreen extends StatefulWidget {
  ...
  EntertainmentNewsScreen({required this.category});
  @override
...
class _EntertainmentNewsScreenState extends State<EntertainmentNewsScreen> {
  final EntertainmentNewsService _newsService = EntertainmentNewsService();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            '${widget.category == 'entertainment' ? 'Entertainment' : ''} News'),
        leading: IconButton(
  ...
  NewsArticle _findArticle(String newsTitle) {
    // Find the article based on the news title
